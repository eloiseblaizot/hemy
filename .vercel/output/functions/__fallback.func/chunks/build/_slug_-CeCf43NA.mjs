...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    if (data.value?.elu?.chambre === "AN") {
      [__temp, __restore] = withAsyncContext(() => navigateTo(`/deputes/${encodeURIComponent(slug.value)}`, { redirectCode: 301 })), await __temp, __restore();
    }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/senateurs/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_slug_-CeCf43NA.mjs.map
